...
- **📱 Yerel Mobil Uygulama:** Android için geliştirilmiş, sesli komut entegrasyonlu native uygulama.
...
| :--------------------- | :------- | :---------------------------------------------- |
| `/chat`                | `POST`   | AI ile sohbet et (Web/RAG/Görüntü desteği ile). |
...
- [x] **Mobil Uygulama:** Android native uygulama yayında.
- [ ] **Sesli Komut:** Web üzerinden doğrudan sesli komut alımı.
...
> 🌐 **Güncel Tünel Adresi:** [https://modelling-distinction-opposition-renew.trycloudflare.com](https://modelling-distinction-opposition-renew.trycloudflare.com)
